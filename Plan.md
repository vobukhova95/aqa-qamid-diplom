...
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести 17 цифр.
...
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести латиницу: "abcd"
...
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести кириллицу: "абвг"
...
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести символы: "`!@#$ %^&* ()__ +{}"
...
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести пробелы: " "
...
1. Нажать кнопку "Купить"
2. В поле "Месяц" ввести значение из трех цифр: "088"
...
1. Нажать кнопку "Купить"
2. В поле "Месяц" ввести латиницу: "asd"
...
1. Нажать кнопку "Купить"
2. В поле "Месяц" ввести кириллицу: "ghе"
...
1. Нажать кнопку "Купить"
2. В поле "Год" ввести трех цифр: "255"
...
1. Нажать кнопку "Купить"
2. В поле "Год" ввести кириллицу: "фыв"
...
1. Нажать кнопку "Купить"
2. В поле "Год" ввести латиницу: "vfw"
...
**Сценарий 1: Ввод имени с дефисом в поле "Владелец"**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год +1: "26"
...
**Сценарий 2: Ввод имени с апострофом в поле "Владелец"**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год +1: "26"
...
**Сценарий 3: Проверка минимально допустимого количества символов поле "Владелец": две буквы через пробел**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год +1: "26"
...
**Сценарий 4: Проверка граничного значения в поле "Владелец": 3 буквы и один пробел**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год +1: "26"
...
**Сценарий 5: Ввод множественных частей имени в поле "Владелец"**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год +1: "26"
...
**Сценарий 6: Проверка максимально допустимого количества смиволов поле "Владелец": 50 букв**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год +1: "26"
...
**Сценарий 6: Ввод граничного значения в поле "Владелец": макимально допустимая длина(50) + 1**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год + 1: "26"
...
**Сценарий 7: Ввод граничного значения в поле "Владелец": минимально допустимая длина(3) минус 1**
1. Нажать кнопку "Купить"
2. В поле "Номер карты" ввести: "1111 2222 3333 4444"
3. В поле "Месяц" ввести месяц в диапазоне от 01-12: "07"
4. В поле "Год" ввести последние 2 цифры года из расчета текущий год + 1: "26"
...
1. Нажать кнопку "Купить"
2. В поле "CVC/CVV" ввести 4 цифры: "1000"
...
1. Нажать кнопку "Купить"
2. В поле "CVC/CVV" ввести кириллицу: "ввпр"
...
1. Нажать кнопку "Купить"
2. В поле "CVC/CVV" ввести латиницу: "dffr"
...
1. Нажать кнопку "Купить"
2. В поле "CVC/CVV" ввести символы: "!%@"
...
1. Нажать кнопку "Купить"
2. В поле "CVC/CVV" ввести пробелы: " "
